...

	{
...

		{
...

			{
				...
				echo  '<node TEXT="'.cleanText($Chap).'" LINK = "'.cleanWikiLink($wikilink).'" TOOLTIPTEXT = "'.$tooltip."\"> \n";
...

		{
...

			{
				...
				echo  '<node TEXT="'.cleanText($SubChap).'" LINK = "'.cleanWikiLink($wikilink).'" TOOLTIPTEXT = "'.$tooltip."\">\n";
...

		{
...

			{
				...
				$wwwLinkName = preg_replace("/[\n&]/", "%26", cleanText($wwwLinkName));

				$wwwLinkURL = preg_replace("/[\n&]/", "%26", $wwwLinkURL);

				echo '<node TEXT="'.$wwwLinkName.'" LINK="'.$wwwLinkURL."\">\n";
